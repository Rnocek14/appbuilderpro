...
const EmailDomains = lazy(() => import('./pages/EmailDomains'));
...
const FlagshipArtist = lazy(() => import('./pages/dev/FlagshipArtist'));
    ...
    <ErrorBoundary resetKey={location.pathname}>
      <Suspense fallback={<div className="flex min-h-screen items-center justify-center"><Spinner label="Loading…" /></div>}>
        <Routes>
          ...
          <Route path="/garvis/email-domains" element={<Protected><EmailDomains /></Protected>} />
          ...
          {import.meta.env.DEV && <Route path="/dev/flagship-artist" element={<FlagshipArtist />} />}
