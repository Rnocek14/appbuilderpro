  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-center font-display text-3xl font-bold">Simple, self-hosted pricing</h1>
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2">
          {PLANS.map((plan) => (
            <div
              key={plan.id}
              className={`rounded-2xl border p-6 ${plan.highlight ? 'border-forge-ember/50 bg-forge-panel shadow-ember' : 'border-forge-border bg-forge-panel'}`}
            >
