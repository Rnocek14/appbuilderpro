...
import { Send, Flame, FileCode2, CircleCheck, CircleDashed, CircleX } from 'lucide-react';
import type { AIMessage, Generation } from '../../types';
...
export function ChatPanel({ messages, activeGeneration, busy, askOptions = [], stream = null, onSend }: Props) {
